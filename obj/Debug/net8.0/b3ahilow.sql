...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260309102519_isArchived_added_in_taskmembers'
)
BEGIN
    ALTER TABLE [TaskMembers] ADD [IsArchived] bit NOT NULL DEFAULT CAST(0 AS bit);
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260309102519_isArchived_added_in_taskmembers', N'8.0.23');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260503062513_AddSuperAdminTable'
)
BEGIN
    CREATE TABLE [SuperAdmins] (
        ...
        CONSTRAINT [PK_SuperAdmins] PRIMARY KEY ([Id]),
        CONSTRAINT [FK_SuperAdmins_AspNetUsers_UserId] FOREIGN KEY ([UserId]) REFERENCES [AspNetUsers] ([Id]) ON DELETE CASCADE
    );
END;
GO
...
BEGIN
    CREATE INDEX [IX_SuperAdmins_UserId] ON [SuperAdmins] ([UserId]);
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260503062513_AddSuperAdminTable', N'8.0.23');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260503165521_AddSecurityLogTable'
)
BEGIN
    CREATE TABLE [SecurityLogs] (
        ...
        [MitigationPlan] nvarchar(1000) NULL,
        [ContainmentStrategy] nvarchar(1000) NULL,
        [ThreatLevel] int NOT NULL,
        [AccountLockedOut] bit NOT NULL,
        [AccountLockoutTime] datetime2 NULL,
        [Timestamp] datetime2 NOT NULL,
        [EventProperties] nvarchar(2000) NULL,
        CONSTRAINT [PK_SecurityLogs] PRIMARY KEY ([Id]),
        CONSTRAINT [FK_SecurityLogs_AspNetUsers_UserId] FOREIGN KEY ([UserId]) REFERENCES [AspNetUsers] ([Id])
    );
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260503165521_AddSecurityLogTable', N'8.0.23');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260503171453_UpdateSecurityLogSchema'
)
BEGIN
    EXEC sp_rename N'[SecurityLogs].[Level]', N'ThreatLevel', N'COLUMN';
END;
GO
...
BEGIN
    EXEC sp_rename N'[SecurityLogs].[Properties]', N'EventProperties', N'COLUMN';
END;
GO
...
BEGIN
    ALTER TABLE [SecurityLogs] ADD [AccountLockedOut] bit NOT NULL DEFAULT CAST(0 AS bit);
END;
GO
...
BEGIN
    ALTER TABLE [SecurityLogs] ADD [AccountLockoutTime] datetime2 NULL;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260503171453_UpdateSecurityLogSchema', N'8.0.23');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260503172035_FixThreatLevelDataType'
)
BEGIN
...
BEGIN
    ...
    FROM [sys].[default_constraints] [d]
    INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
    WHERE ([d].[parent_object_id] = OBJECT_ID(N'[SecurityLogs]') AND [c].[name] = N'ThreatLevel');
    IF @var12 IS NOT NULL EXEC(N'ALTER TABLE [SecurityLogs] DROP CONSTRAINT [' + @var12 + '];');
    ALTER TABLE [SecurityLogs] ALTER COLUMN [ThreatLevel] int NOT NULL;
    ALTER TABLE [SecurityLogs] ADD DEFAULT 1 FOR [ThreatLevel];
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260503172035_FixThreatLevelDataType', N'8.0.23');
END;
GO
